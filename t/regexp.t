...
my $re_full = "(?^ux: $re_short (?= \\P{Lao} | \\s | \$ | $re_short ) )";

my $re_is = Lingua::LO::Transform::Data::get_sylre_basic;
is("$re_is", $re_short, "Basic regexp OK");
$re_is = Lingua::LO::Transform::Data::get_sylre_full;
is("$re_is", $re_full, "Full regexp OK");
done_testing;
